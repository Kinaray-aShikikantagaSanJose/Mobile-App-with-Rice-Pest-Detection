...
@Preview(name: 'F51SpreadMap', size: Size(390.0, 844.0))
Widget previewF51SpreadMap() {
...
// F51SpreadMap
// ------------------------------------------------------------------
class F51SpreadMap extends StatefulWidget {
	const F51SpreadMap({super.key});

	@override
	F51SpreadMapState createState() => F51SpreadMapState();
}

class F51SpreadMapState extends State<F51SpreadMap> {
	@override
	void initState() {
		super.initState();
